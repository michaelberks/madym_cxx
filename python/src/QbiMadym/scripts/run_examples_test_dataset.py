...
## 1.1 Fit T1
madym_T1.run(
    config_file = os.path.join(data_dir, 'madym_T1_config.txt'),
    working_directory = os.path.join(data_dir, 'test_dataset'))
#%% 1.2 Detect AIF
madym_AIF.run(
    config_file = os.path.join(data_dir, 'madym_AIF_config.txt'),
    working_directory = os.path.join(data_dir, 'test_dataset'))

#%% 1.3 Fit ETM
madym_DCE.run(
    config_file = os.path.join(data_dir, 'madym_ETM_auto_config.txt'),
    working_directory = os.path.join(data_dir, 'test_dataset'))
