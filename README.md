...
5. (Optional) Doxygen to build documentation from source code comment tags
...
Assuming you've got here and everything has built successfully... great! You're good to go and start doing some DCE analysis. Please see the wiki for detailed instructions on how to use Madym.
