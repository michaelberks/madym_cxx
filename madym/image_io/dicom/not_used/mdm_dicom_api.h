...
#ifndef MDM_DICOM_API_H
#define MDM_DICOM_API_H
...
#  ifdef MDM_DICOM_API_EXPORTS
#    define MDM_DICOM_API __declspec(dllexport)
#  else
#    define MDM_DICOM_API __declspec(dllimport)
#  endif
#else
#  define MDM_DICOM_API
#endif
