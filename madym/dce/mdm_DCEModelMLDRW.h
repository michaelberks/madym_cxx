...
*/
#ifndef mdm_DCEModelMLDRW_HDR
#define mdm_DCEModelMLDRW_HDR
...
class mdm_DCEModelMLDRW : public mdm_DCEModelBase {
public:
	
  //! ETM model constructor
  MDM_API mdm_DCEModelMLDRW(
    mdm_AIF &AIF,
