  ...
  :mdm_DCEModelBase(AIF, pkParamNames, pkInitParams, fixedParams, fixedValues)
{
  ...
  if (upperBounds_.empty())
    upperBounds_ = { 10.0, 10.0, 10.0, 10.0, 0.5 };//, 0.1
...
MDM_API double mdm_DCEModel2CXM::checkParams()
{
